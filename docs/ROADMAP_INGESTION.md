...
| 3.4.3 | ColBERT late-interaction on abstracts collection | Q | M | M | **Shipped 54.6.227 + 54.6.228** | Phase 1: embed-time infra + multi-vector collection config. Phase 2: dense-prefetch + MAX_SIM rerank via Qdrant query_points API. Opt-in via ENABLE_COLBERT_ABSTRACTS |
